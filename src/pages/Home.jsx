  ...
  return (
    <section className="mx-auto grid max-w-7xl gap-8 px-4 py-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
      <div className="space-y-6">
        ...
        <h1 className="text-5xl font-black tracking-tight text-slate-950 dark:text-white md:text-7xl">Tu comida lista entre clases.</h1>
        <p className="max-w-2xl text-lg text-slate-600 dark:text-slate-300">CampusFood simula una app de delivery para cafetería universitaria con catálogo, carrito interactivo, validaciones, chatbot y seguimiento visual del pedido.</p>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {[
            ...
            [Sparkles, 'Interactividad', 'Animaciones, chatbot y estados.'],
          ].map(([Icon, title, text]) => (
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="relative">
        <div className="rounded-[2.5rem] bg-gradient-to-br from-orange-400 via-amber-300 to-orange-100 p-8 shadow-2xl shadow-orange-500/20 dark:from-orange-600 dark:via-orange-500 dark:to-slate-800">
          <div className="rounded-[2rem] bg-white/90 p-6 dark:bg-slate-950/80">
            <p className="text-sm font-bold text-orange-600">Promo del día</p>
