...
export function Navbar({ page, setPage, cartCount, dark, toggleTheme, openCart }) {
  return (
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        <button onClick={() => setPage('home')} className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <p className="text-xs font-medium text-slate-500 dark:text-slate-400">Cafetería universitaria</p>
          </div>
        </button>
